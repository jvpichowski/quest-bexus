...
![Jan von Pichowski]({{ site.url }}/images/profiles/Jan_von_Pichowski.jpg){:style="float: left; margin-right: 1em; width: 150px;"} Jan is the student team leader and therefor responsible for the overall management of the QUEST team. He is the main contact person and in charge of the documentation.
...
![Ric Dengel]({{ site.url }}/images/profiles/Ric_Dengel.jpg){:style="float: left; margin-right: 1em; width: 150px;"} Ric is leader of the electrical engineering team and therefore responsible for the electronic setup and compatibility of electronic with software and structure.
...
![Valentin Huber]({{ site.url }}/images/profiles/Valentin_Huber.jpg){:style="float: left; margin-right: 1em; width: 150px;"} Valentin is part of the electrical engineering team and works on the OBDH Module. In addition, he supports other electrical engineering team members with small tasks.
...
![Peter Stöferle]({{ site.url }}/images/profiles/Peter_Stoeferle.jpg){:style="float: left; margin-right: 1em; width: 150px;"} Peter is the leader of the mechanical design and integration team. He is responsible for the mechanical and thermal setup.
...
![Isabell Wittekind]({{ site.url }}/images/profiles/Isabell_Wittekind.jpg){:style="float: left; margin-right: 1em; width: 150px;"} Isabell is part of the mechanical design and evaluation team. She works on the mechanical setup and is responsible for the scientific data preparation and analysis.
...
![Alexander Rabinowitsch]({{ site.url }}/images/profiles/Alexander_Rabinowitsch.jpg){:style="float: left; margin-right: 1em; width: 150px;"} Alexander is part of the mechanical engineering and integration team. His responsibilities include the mechanical and thermal setup. Alexander’s motive in participating at QUEST is his motivation in being part of an ambitious space engineering project and strengthen his skills in CAD.
...
![Sebastian Scholz]({{ site.url }}/images/profiles/Sebastian_Scholz.jpg){:style="float: left; margin-right: 1em; width: 150px;"} Sebastian is part of the software team and works on the cluster analysis as well as tools to generate the data needed for the cluster analysis.
...
![Eike Steinweg]({{ site.url }}/images/profiles/Eike_Steinweg.jpg){:style="float: left; margin-right: 1em; width: 150px;"} Eike is part of the software team and works on the cluster analysis.
...
![Dominik Woiwode]({{ site.url }}/images/profiles/Dominik_Woiwode.jpg){:style="float: left; margin-right: 1em; width: 150px;"} Dominik is part of the software team and responsible for the ground station software.
...
![Lukas Zembrot]({{ site.url }}/images/profiles/Lukas_Zembrot.jpg){:style="float: left; margin-right: 1em; width: 150px;"} Lukas is part of the software team and works on the software design and its implementation.
...
![Nico Florschützr]({{ site.url }}/images/profiles/Nico_Florschuetz.png){:style="float: left; margin-right: 1em; width: 150px;"} The main task for Nico will be the simulation, validation and testing of the individual components of QUEST. He therefore will manage the test facilities and develop the test plan.
...
![Benjamin Stippel]({{ site.url }}/images/profiles/Benjamin_Stippel.jpg){:style="float: left; margin-right: 1em; width: 150px;"} Benjamin is part of the mechanical design and evaluation team. He works on the mechanical setup, CAD modelling, and is responsible for the scientific data preparation and analysis.
...
![Tim Muller]({{ site.url }}/images/profiles/Tim_Muller.png){:style="float: left; margin-right: 1em; width: 150px;"} As part of public outreach Tim is in charge of the website by designing it and providing all information about QUEST and the REXUS/BEXUS program. Also posting regularly news on social media and the website is part of his duty.
...
![Hans Schülein]({{ site.url }}/images/profiles/Hans_Schuelein.jpg){:style="float: left; margin-right: 1em; width: 150px;"} Hans is part of the electrical engineering team and works on a variety of modules and different tasks.
...
![Alexander Zaft]({{ site.url }}/images/profiles/Alexander_Zaft.jpg){:style="float: left; margin-right: 1em; width: 150px;"} Alexander is part of the software team and works on the framework around the algorithm.
...
![Katrin Griebenow]({{ site.url }}/images/profiles/Katrin_Griebenow.jpg){:style="float: left; margin-right: 1em; width: 150px;"} As a part of public outreach, it is Katrins task to deliver information about the projects progress on the internet regularyly. This includes taking care of the website and our social media presence.
